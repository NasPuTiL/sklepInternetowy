...
join sklep skl on u.sklep_nip_firmy = skl.nip_firmy 
join pracownik pr on u.pracownik_id_pracownika = pr.id_pracownika ;
...
from klient k 
 join paragon_faktura pf on k.numer_klienta = pf.klient_numer_klienta 
 join szczegoly_transakcji st on pf.numer_paragonu_faktury = st.numer_paragonu_faktury 
 join towar tw on st.towar_id_towaru = tw.id_towaru 
